...
Use the ai-dev-container installer skill to automatically set up AI Dev Container in your project:

1. Run `claude` in your project directory
2. `/plugin add marketplace mithredate/claude-codex`
3. `/plugin install development@claude-codex`
4. Type `install ai-dev-container`

Claude will analyze your project, set up Docker Compose, create the bridge configuration, and provide instructions to run it.
